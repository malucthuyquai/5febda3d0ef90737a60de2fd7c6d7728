...
//Appstore link
#define kAppStoreLink           @"https://itunes.apple.com/us/app/crazy-escape-copters/id916094192?ls=1&mt=8"
...
void Translate::submitGCScore(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    GKHWrapperCpp *gkh;
    NSString *cat = @"mobi.smartad.crazyescape";
...
void Translate::share(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    NSString *textToShare = [NSString stringWithFormat:@"I can't bear @crazy-escape within %.0f seconds, How long can you bear? %@", g->score, kAppStoreLink];
    if (g->score < 2.0) {
        textToShare = [NSString stringWithFormat:@"I can't bear @crazy-escape within %.0f second, How long can you bear? %@", g->score, kAppStoreLink];
    }
