...
//GameCenter
#define kLeaderBoard            @"grp.stickmanjump"

//Appstore link
//#define kAppStoreLink           @"https://itunes.apple.com/us/app/make-stickman-jump/id905743475?ls=1&mt=8"
#define kAppStoreLink             @"http://appvn.com/i/29207"
...
void Translate::submitGCScore(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    GKHWrapperCpp *gkh;
    NSString *cat = [NSString stringWithFormat:@"grp.stickmanjump.%dstickman", g->level];
...
void Translate::share(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    NSString *textToShare = [NSString stringWithFormat:@"I scored %.0f points in @makestickmanjump , can you get higher than me? %@", g->score, kAppStoreLink];
    if (g->score < 2.0) {
        textToShare = [NSString stringWithFormat:@"I scored %.0f point in @makestickmanjump , can you get higher than me? %@", g->score, kAppStoreLink];
    }
...
void Translate::showadmobfull(Ref *object) {
    ...
    NSDate *date2 = [dateFormatter dateFromString: @"2014-08-30 00:00:01 GMT-07:00"];
