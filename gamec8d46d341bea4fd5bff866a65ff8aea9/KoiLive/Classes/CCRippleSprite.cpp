...
void pgeRippleSprite::draw(Renderer* renderer, const kmMat4& transform, bool transformUpdated)
{
...
void pgeRippleSprite::onEnterTransitionDidFinish()
{
    ...
    touchListener->onTouchBegan = CC_CALLBACK_2(pgeRippleSprite::ccTouchBegan, this);
    touchListener->onTouchMoved = CC_CALLBACK_2(pgeRippleSprite::ccTouchMoved, this);
    touchListener->onTouchEnded = CC_CALLBACK_2(pgeRippleSprite::ccTouchEnded, this);
    touchListener->onTouchCancelled = CC_CALLBACK_2(pgeRippleSprite::ccTouchCancelled, this);
