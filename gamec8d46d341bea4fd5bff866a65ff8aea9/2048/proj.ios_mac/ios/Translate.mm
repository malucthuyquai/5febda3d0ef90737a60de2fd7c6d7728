...
//Appstore link
//#define kAppStoreLink           @"https://itunes.apple.com/us/app/2048-classic-hd/id913983400?ls=1&mt=8"
#define kAppStoreLink           @"https://itunes.apple.com/us/app/2048-new-season/id930823795?ls=1&mt=8"
...
void Translate::submitGCScore(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    GKHWrapperCpp *gkh;
    NSString *cat = [NSString stringWithFormat:@"mobi.smartad.2048new"];
...
void Translate::share(cocos2d::Ref *object) {
    Global *g = Global::sharedGlobal();
    NSString *textToShare = [NSString stringWithFormat:@"I scored %.0f points in @2048 new season , can you get higher than me? %@", g->score, kAppStoreLink];
    if (g->score < 2.0) {
        textToShare = [NSString stringWithFormat:@"I scored %.0f point in @2048 new season , can you get higher than me? %@", g->score, kAppStoreLink];
    }
...
void Translate::showadmobfull(Ref *object) {
    ...
    NSDate *date2 = [dateFormatter dateFromString: @"2014-09-15 00:00:01 GMT-07:00"];
