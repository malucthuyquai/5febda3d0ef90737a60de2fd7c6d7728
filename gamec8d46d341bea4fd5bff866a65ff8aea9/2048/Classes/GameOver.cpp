...
bool GameOver::init()
{
    ...
    auto *title = Label::createWithTTF("GAME OVER", "ClearSans-Bold.ttf", 100*realScale);
    ...
    addChild(leasy);
    auto *best1 = Label::createWithTTF("SCORE", "ClearSans-Bold.ttf", 40*realScale);
    best1->setScale(0.5);
    ...
    auto *lbl1 = Label::createWithTTF(scorestr, "ClearSans-Bold.ttf", 120*realScale);
    lbl1->setScale(0.5);
    lbl1->setColor(Color3B(254,254,254));
    lbl1->setPosition(160*realScale, 150*realScale);
    leasy->addChild(lbl1);
    best1 = Label::createWithTTF("BEST", "ClearSans-Bold.ttf", 40*realScale);
    best1->setScale(0.5);
    best1->setColor(Color3B(254,254,254));
    best1->setPosition(160*realScale, 100*realScale);
    leasy->addChild(best1);
    int hs = UserDefault::getInstance()->getIntegerForKey(M_FILE_KEY_HIGHT_SCORE, 0);
    const char *best = __String::createWithFormat("%.d", hs)->getCString();
    lbl1 = Label::createWithTTF(best, "ClearSans-Bold.ttf", 120*realScale);
    lbl1->setScale(0.5);
    lbl1->setColor(Color3B(254,254,254));
    ...
    addChild(leasy);
    lbl1 = Label::createWithTTF("SHARE", "ClearSans-Bold.ttf", 70*realScale);
    lbl1->setScale(0.5);
    lbl1->setColor(Color3B(254,254,254));
    ...
    addChild(leasy);
    lbl1 = Label::createWithTTF("TRY AGAIN", "ClearSans-Bold.ttf", 70*realScale);
    lbl1->setScale(0.5);
    lbl1->setColor(Color3B(254,254,254));
    lbl1->setPosition(160*realScale, 40*realScale);
    leasy->addChild(lbl1);
    ...
    addChild(leasy);
    lbl1 = Label::createWithTTF("BACK HOME", "ClearSans-Bold.ttf", 70*realScale);
    lbl1->setScale(0.5);
    lbl1->setColor(Color3B(254,254,254));
    lbl1->setPosition(160*realScale, 40*realScale);
    leasy->addChild(lbl1);
