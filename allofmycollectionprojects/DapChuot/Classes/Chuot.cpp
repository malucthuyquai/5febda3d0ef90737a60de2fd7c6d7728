...
bool Chuot::init()
{
    ...
    CCTexture2D *texture = textureCache->addImage("images/Mouse.png");
    this->setTexture(texture);
    this->setTextureRect(CCRectMake(0, 0, 230/scaleFactor, 250/scaleFactor));
    CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("images/Mouse.plist");
    CCSpriteFrameCache::sharedSpriteFrameCache()->addSpriteFramesWithFile("images/Mouse2.plist");
