...
#define _X                      CCDirector::sharedDirector()->getVisibleOrigin().x
#define _Y                      CCDirector::sharedDirector()->getVisibleOrigin().y
#define _W                      CCDirector::sharedDirector()->getVisibleSize().width
#define _H                      CCDirector::sharedDirector()->getVisibleSize().height
...
//Audio
#define audio                   (CocosDenshion::SimpleAudioEngine::sharedEngine())
//App delegate
...
//User default
#define USER_DF                 (CCUserDefault::sharedUserDefault())
//Global
#define global                  Global::sharedGlobal()
//File Utils
#define fileUtils               CCFileUtils::sharedFileUtils()
//Notification Center
